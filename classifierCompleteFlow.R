...
#======================================================================== 
  ...
  db=read.csv('/Users/fuyincherng/Documents/EPFLCourse/DigitalEducation/R/Project/OutputTable.csv', stringsAsFactors = F)
  ...
  fs=c('TimeSinceLast','SubmissionNumber',
       ...
       'NumberOfPostsEvent','NumberOfSubscribe',
       'NumberOfLaunch','NumberOfComments')
